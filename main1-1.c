...
{
	system("cls");
	printf("                                                     WELCOME TO FOOD COURT MANAGEMENT SYSTEM\n");
  printf("                                                    <=======================================>          \n\n");
	...
	else if(choice==4)
	{
		...
		printf("*********Feeling HUNGRY ? Walk-In Food Court***************\n\n");
		exit(0);
	}
}
...
void nonvegetarian(void)
{
	...
	printf("                                                  Non Veg. Menu\n");
	printf("                                    **********************************************\n");
   	printf("1. Omelette            100-\n\n2. Chicken Manchurian  120-\n\n3. Chicken Momos       85-\n\n4. Grilled Egg Chesse Sandwich   50-\n\n5. Back To Main Menu\n\n\nEnter Your Choice");
	char n;
	FILE *nmenu;
...
void beverages(void)
{
	...
	printf("                                    **********************************************\n");
	printf("          1.Lime Soda               20/-\n          2.Tea                     10/-\n          3.Ice Tea                 20/-\n          4.Coffe                   20/-\n          5.Shakes-->\n            1.Choclate Shake      20/-\n            2.Strawberry Shake    30/-\n          6. Back To Main Menu\n\n Enter Your Choice-->  ");
	char b;
	FILE *bmenu;
	
	bmenu=fopen("beveragemenu.txt","rxt");
	while((b=getc(bmenu))!=EOF)
	{
		printf("%c",b);
	}
	fclose(bmenu);
...
void details(void)
{
	...
	printf("                       *********************************************************************************************\n");
	printf("                                             Your Order Will Be At Your Table within 30 minutes.\n");
